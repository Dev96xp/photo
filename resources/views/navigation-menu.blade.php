    @php
        ...
        // Obtiene todos los datos de las paginas, paar generar un array con ellas y generar el menu dinamicamente
        use App\Models\Page;
        $nav_links = Page::all();
    ...
    <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    {{-- Logo png --}}
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('home') }}"><img class="block h-11 w-auto"
                                src="/img/home/nucleus.png" alt="nucleu.png"></a>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        @foreach ($nav_links as $nav_link)
                            @if ($nav_link['status'] == 'INACTIVE')
                                {{-- No muestro nada --}}
                            @else
                                <x-nav-link href="{{ $nav_link['route'] }}" :active="request()->routeIs($nav_link['active'])">
                                    {{ $nav_link['name'] }}
                                </x-nav-link>
                            @endif
                        @endforeach
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                @foreach ($nav_links as $nav_link)
                    <x-responsive-nav-link href="{{ $nav_link['route'] }}" :active="request()->routeIs($nav_link['active'])">
                        {{ $nav_link['name'] }}
